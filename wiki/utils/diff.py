...
#
# NOTE CHANGES: 
# 1. Removed 4 instances of Markup( ... ) wrapping output (such as lines).
# 2. Manually moved over expandtabs from text.py to not have a lot of
#    dependencies.
# 3. Replaced genshi.escape with cgi.escape.
...
#Manually ported over from text.py
